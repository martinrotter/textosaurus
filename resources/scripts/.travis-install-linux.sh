...
echo "| $(date +'%m-%d-%Y %T') | [$git_revision](https://github.com/martinrotter/textilosaurus/commit/$git_revision) | [transfer.sh]($url) |  "$'\r' >> ./build-wiki/Linux-development-builds.md
